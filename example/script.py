...
@click.argument('comparison_list_file', type=click.Path(exists=True))
...
def main(input_data_file, chrom_size_file, comparison_list_file, window_size, bin_size, chroms_to_load, min_loop_value, min_bedgraph_value,
         num_peaks):
    ...
    emd_scores, j_scores = \
        chia_rep.compare(sample_data_dict, comparison_list_file=comparison_list_file,
    ...
    # ]
    # emd_scores, j_scores = \
    #     chia_rep.compare(sample_data_dict, comparison_list=comparison_list,
    #                      window_size=window_size, bin_size=bin_size)

    chia_rep.output_to_csv(emd_scores, j_scores)
