...
def get_coefficients(bedgraph1_stat, bedgraph2_stat, min_value):
    ...
    table = PrettyTable(['r', 'adj_r2'])
    table.add_row([round(pearson_value, 4), round(adjusted_r2, 4)])
    print(table)
    ...
    return pearson_value, adjusted_r2


def compare(bedgraph1_stat, bedgraph2_stat, min_value=0):
    pearson_value, adjusted_r2 = \
        get_coefficients(bedgraph1_stat, bedgraph2_stat, min_value)
    results = {
        'graph_type': 'pearson',
        'main': pearson_value
    }
